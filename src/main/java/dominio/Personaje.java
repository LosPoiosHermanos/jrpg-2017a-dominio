...
public abstract class Personaje extends Character implements Peleable, Serializable {
	 ...
	 */
	/*
	 * public void setEnergia(final int energia) { this.energia = energia; }
	 */
	/**
	 ...
	 */
	/*
	 * public void setDestreza(final int destreza) { this.destreza = destreza; }
	 */
	 ...
	 */
	/*
	 * public void setInteligencia(final int inteligencia) { this.inteligencia =
	 * inteligencia; }
	 */
	 ...
	 */
	/*
	 * public void setCasta(final Casta casta) { this.casta = casta; }
	 */
	 ...
	 */
	/*
	 * public void setExperiencia(final int experiencia) { this.experiencia =
	 * experiencia; }
	 */
	/**
	 ...
	 */
	/*
	 * public void setIdPersonaje(final int idPersonaje) { this.idPersonaje =
	 * idPersonaje; }
	 */
	/**
	 ...
	 * 
	 * @param saludTope
	 *            Valor de la Salud al tope
	 */
	/*
	 * public void setSaludTope(final int saludTope) { this.saludTope =
	 * saludTope; }
	 */
	 ...
	 * 
	 * @param energiaTope
	 *            Valor de la Energia al tope
	 */
	/*
	 * public void setEnergiaTope(final int energiaTope) { this.energiaTope =
	 * energiaTope; }
	 */
	...
	public int atacar(final Peleable atacado, final RandomGenerator random) {
		...
		if (atacado.getSalud() > 0) {
			if (random.nextDouble() <= this.casta.getProbabilidadGolpeCritico() + this.destreza / DIVISORDEDESTREZA) {
	 ...
	 * 
	 * @return int Es la Energia extra, puede ser 0(Orco) , 5(Humano) o 10
	 *         (Elfo)
	 */
	 ...
	 * 
	 * @param aumento
	 *            Valor que se le suma al actual
	 */
